...
if($js -notmatch 'projectHealthV011'){throw "app.js is not v0.11"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.11'){throw "index.html is not v0.11"}
Write-Host "Project Health v0.11 deploy tree validated." -ForegroundColor Green
