...
$Release = Join-Path $ProjectRoot "releases\v0.6"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.6-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.6 OneDrive installer" -ForegroundColor Cyan
