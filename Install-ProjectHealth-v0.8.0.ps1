...
$Release = Join-Path $ProjectRoot "releases\v0.8.0"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.8.0-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.8.0 OneDrive installer" -ForegroundColor Cyan
