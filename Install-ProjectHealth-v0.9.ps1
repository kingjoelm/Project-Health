...
$Release = Join-Path $ProjectRoot "releases\v0.9"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.9-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.9 OneDrive installer" -ForegroundColor Cyan
