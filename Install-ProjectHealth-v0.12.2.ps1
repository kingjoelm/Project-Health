...
$Release = Join-Path $ProjectRoot "releases\v0.12.2"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.12.2-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.12.2 OneDrive installer" -ForegroundColor Cyan
...
$Items = @("assets","data","docs","cloud","index.html","app.js","manifest.webmanifest","service-worker.js","README.md","CHANGELOG.md")
