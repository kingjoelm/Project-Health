...
if($js -notmatch 'projectHealthV081'){throw "app.js is not v0.8.1"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.8.1'){throw "index.html is not v0.8.1"}
Write-Host "Project Health v0.8.1 deploy tree validated." -ForegroundColor Green
