...
if($js -notmatch 'projectHealthV012'){throw "app.js is not v0.12"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.12'){throw "index.html is not v0.12"}
Write-Host "Project Health v0.12 deploy tree validated." -ForegroundColor Green
