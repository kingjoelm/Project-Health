...
$Release = Join-Path $ProjectRoot "releases\v0.11"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.11-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.11 OneDrive installer" -ForegroundColor Cyan
