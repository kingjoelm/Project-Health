...
Write-Host ""
Write-Host "Project Health Cloud Configuration v0.12.2" -ForegroundColor Cyan
...
window.PROJECT_HEALTH_CLOUD = {
  enabled: true,
  supabaseUrl: "https://sjjyrjztdgvqzuupftow.supabase.co",
...
Write-Host "  .\Validate-ProjectHealth-Cloud-v0.12.2.ps1"
Write-Host "  .\Install-ProjectHealth-v0.12.2.ps1"
