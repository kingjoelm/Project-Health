...
$Release = Join-Path $ProjectRoot "releases\v0.8.1"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.8.1-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.8.1 OneDrive installer" -ForegroundColor Cyan
