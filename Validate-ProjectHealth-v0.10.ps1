...
if($js -notmatch 'projectHealthV010'){throw "app.js is not v0.10"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.10'){throw "index.html is not v0.10"}
Write-Host "Project Health v0.10 deploy tree validated." -ForegroundColor Green
