...
$Release = Join-Path $ProjectRoot "releases\v0.12"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.12-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.12 OneDrive installer" -ForegroundColor Cyan
