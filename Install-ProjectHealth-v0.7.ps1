...
$Release = Join-Path $ProjectRoot "releases\v0.7"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.7-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.7 OneDrive installer" -ForegroundColor Cyan
