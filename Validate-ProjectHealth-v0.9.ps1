...
if($js -notmatch 'projectHealthV09'){throw "app.js is not v0.9"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.9'){throw "index.html is not v0.9"}
Write-Host "Project Health v0.9 deploy tree validated." -ForegroundColor Green
