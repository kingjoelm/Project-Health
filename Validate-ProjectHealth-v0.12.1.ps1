...
if($js -notmatch 'projectHealthV012'){throw "app.js is not v0.12.1"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.12'){throw "index.html is not v0.12.1"}
Write-Host "Project Health v0.12.1 deploy tree validated." -ForegroundColor Green
