...
if($js -notmatch 'projectHealthV07'){throw "app.js is not v0.7"}
$html=Get-Content (Join-Path $Deploy "index.html") -Raw
if($html -notmatch 'Beta 0.7'){throw "index.html is not v0.7"}
Write-Host "Project Health v0.7 deploy tree validated." -ForegroundColor Green
