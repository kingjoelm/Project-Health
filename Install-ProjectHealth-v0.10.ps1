...
$Release = Join-Path $ProjectRoot "releases\v0.10"
$Backup = Join-Path $ProjectRoot ("backups\pre-v0.10-" + (Get-Date -Format "yyyyMMdd-HHmmss"))

Write-Host "Project Health v0.10 OneDrive installer" -ForegroundColor Cyan
